...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>. Powered by <a href="http://www.zen-cart.com" target="_blank">Zen Cart</a> / <a href="https://www.bigmouse.co.jp/" target="_blank">bigmouse Inc.</a>');
...
// information box text in sideboxes/information.php
  ...
  define('BOX_INFORMATION_UNSUBSCRIBE', 'メールマガジン登録解除');
...
// javascript messages
  ...
  define('ENTRY_COMPANY', '会社名 部署名:');
  define('ENTRY_COMPANY_ERROR', '会社名 部署名を入力して下さい。');
  ...
  define('ENTRY_DATE_OF_BIRTH_ERROR', '誕生日は[1970/05/21]の書式か、[1970-05-21]のどちらかの書式で入力してください。');
  define('ENTRY_DATE_OF_BIRTH_TEXT', '* (記入例 1970/05/21 もしくは 1970-05-21)');
  ...
  define('ENTRY_STREET_ADDRESS_ERROR', '番地 建物名は最低' . ENTRY_STREET_ADDRESS_MIN_LENGTH . '文字以上入力してください');
  ...
  define('ENTRY_NEWSLETTER', 'メールマガジンを購読する');
...
// payment method is GV/Discount
  ...
  define('TEXT_INVALID_FINISHDATE_COUPON', 'このクーポンは有効期限切れです。');
...
// cart contents
  ...
  define('PRODUCTS_ORDER_QTY_TEXT','カートに追加: ');
...
// product_listing
  ...
  define('ERROR_CORRECTIONS_HEADING','以下の内容に修正が必要です: <br />');
...
// Downloads Controller
  ...
  define('TEXT_FILESIZE_UNKNOWN', '不明');
...
// shopping cart errors
  ...
  define('WARNING_PRODUCT_QUANTITY_ADJUSTED', '商品数量が購入可能な残り在庫数にあわせて変更されました。');
  define('OUT_OF_STOCK_CANT_CHECKOUT', STOCK_MARK_PRODUCT_OUT_OF_STOCK . ' マークが付いている商品は在庫切れ、もしくはご注文を満たすのに十分な在庫がございません。<br /> (' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . ')の付いた商品の数量を変更してご注文ください。ご協力ありがとうございます。');
  define('OUT_OF_STOCK_CAN_CHECKOUT', STOCK_MARK_PRODUCT_OUT_OF_STOCK . ' マークが付いている商品は在庫切れです。<br />在庫が不足した商品につきましてはバックオーダーとして処理させていただきます。');
...
// authorization pending
  ...
  define('TEXT_AUTHORIZATION_PENDING_CHECKOUT', 'ご注文手続きを進めることが出来ません - お客様のアカウントを確認中');
...
// misc
  define('COLON_SPACER', ':&nbsp;&nbsp;');
  define('PAYMENT_JAVASCRIPT_DISABLED', 'JavaScript が無効に設定されているため、注文手続きを進めることが出来ません。　手続きを進めるには有効にする必要があります。');
...
// create account - login shared
  ...
  define('ERROR_TEXT_COUNTRY_DISABLED_PLEASE_CHANGE', '申し訳ありません。現在  "%s" のご住所での支払い、配送に対応しておりません。ご注文手続きを進めるには住所情報を変更なさってください。');

  define('ENTRY_EMAIL_PREFERENCE','メールマガジンおよびEメールについて');
