...
define('SUB_HEADING_TEXT', TEXT_GV_NAMES . 'は当ショップの他の商品と同様にお求めいただけます。<br />当ショップが提供している通常の方法でお支払いができ、お求めいただいた' . TEXT_GV_NAME . 'の金額はお客様の' . TEXT_GV_NAME . 'アカウントに追加されます。<br />お客様の' . TEXT_GV_NAME . 'アカウントに残高がある場合はマイページ内に金額が表示され、メールで' . TEXT_GV_NAME . 'を贈るためのリンクも表示されます。');
  break;
  case '2':
define('SUB_HEADING_TITLE',TEXT_GV_NAMES . 'を贈るには');
define('SUB_HEADING_TEXT','マイページから' . TEXT_GV_NAME . 'を送信することが出来ます。' . TEXT_GV_NAME . 'は、以下の手順で送信することが出来ます：<br />
' . TEXT_GV_NAME . 'を受け取られる方のお名前<br />
' . TEXT_GV_NAME . 'を受け取られる方のメールアドレス<br />
お贈りになる金額 (注意: ' . TEXT_GV_NAME . ' アカウントにある全額を贈る必要はありません)<br />
メールにメッセージを添えることも出来ます<br /><br />
上記の情報を正確にご入力ください。最終的に送信する前に確認・変更できます。');
  break;
  case '3':
