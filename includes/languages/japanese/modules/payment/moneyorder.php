...
//
  ...
  define('MODULE_PAYMENT_MONEYORDER_TEXT_DESCRIPTION', '振込先:&nbsp;' . nl2br(MODULE_PAYMENT_MONEYORDER_PAYTO) . '<br /><br />店舗所在地:<br />' . nl2br(STORE_NAME_ADDRESS) . '<br /><br />' . 'ご入金を確認後、商品を発送いたします。');
