...
define('HEADING_TITLE', 'ご注文内容を確認してください');
...
define('TITLE_CONTINUE_CHECKOUT_PROCEDURE', '<strong>最終ステップ</strong>');
define('TEXT_CONTINUE_CHECKOUT_PROCEDURE', '→『ご注文の確定』ボタンを押して手続きを完了させてください。');
