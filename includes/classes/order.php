...
class order extends base {
  ...
  function query($order_id) {
    ...
    $this->delivery = array('name' => $order->fields['delivery_name'],
                            ...
                            'name_kana' => $order->fields['delivery_name_kana']
                          );
  ...
  function cart() {
    ...
    $customer_address_query = "select c.customers_firstname, c.customers_lastname, c.customers_telephone,
                                    ...
                                    ab.entry_firstname_kana, ab.entry_lastname_kana, ab.entry_fax, ab.entry_telephone
    ...
    */
    ...
    $this->customer = array('firstname' => $customer_address->fields['customers_firstname'],
                            ...
                            'firstname_kana' => $customer_address->fields['entry_firstname_kana'],
                            'lastname_kana' => $customer_address->fields['entry_lastname_kana']
                          );
			  }
...
/* END: ADD MY CUSTOM DETAILS */
  ...
  function send_order_email($zf_insert_id, $zf_mode = FALSE) {
    ...
    $html_msg=array();
    $greet = (defined('ADDRESSFORMAT_EMAIL_GREET')) ? ADDRESSFORMAT_EMAIL_GREET : '';
    //intro area
    $email_order = EMAIL_TEXT_HEADER . EMAIL_TEXT_FROM . STORE_NAME . "\n\n" .
    $this->customer['firstname'] . ' ' . $this->customer['lastname'] . $greet . "\n\n" .
