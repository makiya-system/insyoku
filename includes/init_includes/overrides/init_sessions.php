...
zen_samesite_session_set_cookie_params();
...
if (SESSION_FORCE_COOKIE_USE == 'True') {
  ...
  zen_samesite_setcookie('cookie_test', 'please_accept_for_session', time()+60*60*24*30, $path, (zen_not_null($cookieDomain) ? $domainPrefix . $cookieDomain : ''), $secureFlag);
