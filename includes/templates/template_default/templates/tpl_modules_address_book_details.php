...
<?php echo zen_draw_input_field('firstname_kana', $entry->fields['entry_firstname_kana'], zen_set_field_length(TABLE_CUSTOMERS, 'customers_firstname', '40') . ' id="firstname_kana" placeholder="' . ENTRY_FIRST_NAME_KANA_TEXT . '"' . ((int)ENTRY_FIRST_NAME_MIN_LENGTH > 0 ? ' required' : '')); ?>
<br class="clearBoth" />
<?php } ?>
...
<?php echo zen_draw_input_field('lastname_kana', $entry->fields['entry_lastname_kana'], zen_set_field_length(TABLE_CUSTOMERS, 'customers_lastname', '40') . ' id="lastname_kana" placeholder="' . ENTRY_LAST_NAME_KANA_TEXT . '"' . ((int)ENTRY_LAST_NAME_MIN_LENGTH > 0 ? ' required' : '')); ?>
<br class="clearBoth" />
<?php } ?>
...
<label class="inputLabel" for="suburb"><?php echo ENTRY_TELEPHONE_NUMBER; ?></label>
