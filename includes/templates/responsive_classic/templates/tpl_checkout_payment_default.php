...
日付:<input type="date" name="takeout-date" min="<?php echo $takeoutdate_min; ?>" max="<?php echo $takeoutdate_max; ?>" value="<?php echo $takeoutdate_val; ?>" required>　時間:<input type="time" name="takeout-time"  min="<?php echo $takeouttime_min; ?>" max="<?php echo $takeouttime_max; ?>" value="<?php echo $takeouttime_val; ?>" required>
</fieldset>
<fieldset>
