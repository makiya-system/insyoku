 ...
 */
  ...
  class ot_shipping {
    ...
    function install() {
      ...
      $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('ソート順', 'MODULE_ORDER_TOTAL_SHIPPING_SORT_ORDER', '300', '表示の整列順を設定します。<br />数値が小さいほど上に表示されます。', '6', '2', now())");
      ...
      $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, date_added) values ('送料を無料にする購入金額', 'MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING_OVER', '10000', '設定金額を超える購入の場合は送料を無料にします。', '6', '4', 'currencies->format', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('適用地域', 'MODULE_ORDER_TOTAL_SHIPPING_DESTINATION', 'national', '送料無料設定が適用される地域の指定<br /><br />national - 国内<br />international - 国外<br />both - すべての地域', '6', '5', 'zen_cfg_select_option(array(\'national\', \'international\', \'both\'), ', now())");
    }
