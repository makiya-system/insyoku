 ...
 * @version $Id: ot_cod_table.php 1 2019-04-18 13:53 bigmouse-nfox $
 **/
...
//lagt tilk servicepakke her!!!!
    ...
    function install() {
      ...
      values ('代金引換手数料', 'MODULE_ORDER_TOTAL_COD_TABLE_STATUS', 
      'true', '代金引換手数料を表示しますか？', '6', '1','zen_cfg_select_option(array(\'true\', \'false\'), ', now())");
      ...
      values ('ソート順', 'MODULE_ORDER_TOTAL_COD_TABLE_SORT_ORDER', 
      '998', '表示の整列順を設定します。<br />数値が小さいほど上に表示されます。<br />※ot_totalモジュールよりも必ず上に表示させるようにしてください。', '6', '2', now())");
    }
    function remove() {
      global $db;
      $keys = '';
