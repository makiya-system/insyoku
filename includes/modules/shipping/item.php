...
// class methods
    ...
    function install() {
      global $db;
      $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('商品個数による送料を有効にする', 'MODULE_SHIPPING_ITEM_STATUS', 'False', '商品個数による送料計算を有効にしますか？', '6', '0', 'zen_cfg_select_option(array(\'True\', \'False\'), ', now())");
      $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('商品個数による配送料金', 'MODULE_SHIPPING_ITEM_COST', '250', '注文された商品1個当たりの配送料金を設定します。', '6', '0', now())");
