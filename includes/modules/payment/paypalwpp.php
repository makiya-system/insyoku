...
if (false) { // disabled until clarification is received about coupons in PayPal Wallet
  ...
  function install() {
    ...
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('このモジュールを有効にする', 'MODULE_PAYMENT_PAYPALWPP_STATUS', 'False', 'このモジュールを有効にしますか？', '6', '25', 'zen_cfg_select_option(array(\'True\', \'False\'), ', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('環境設定', 'MODULE_PAYMENT_PAYPALWPP_SERVER', 'live', '<strong>Live: </strong> 本番環境<br><strong>Sandbox: </strong>テスト環境', '6', '25', 'zen_cfg_select_option(array(\'live\', \'sandbox\'), ', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('エクスプレスチェックアウトボタン', 'MODULE_PAYMENT_PAYPALWPP_ECS_BUTTON', 'Off', 'お客様が配送先情報などをショップ上で入力することなく、Paypal 払いを選択することで注文できるように、ショッピングカート画面に「PayPalエクスプレスチェックアウト」ショートカットボタンを表示させることが出来ます。<br />It has been shown to increase sales and conversions when enabled.<br />Default: Off ', '6', '25', 'zen_cfg_select_option(array(\'On\', \'Off\'), ', now())");
     $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('エクスプレスチェックアウト: 確認済み住所情報', 'MODULE_PAYMENT_PAYPALWPP_CONFIRMED_ADDRESS', 'No', 'ペイパル内で配送先住所を選択する際に確認済み住所情報を必須にしますか？（※日本ではこのサービスは利用できません）', '6', '25',  'zen_cfg_select_option(array(\'Yes\', \'No\'), ', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('エクスプレスチェックアウト: 最も安価な送料を自動選択する', 'MODULE_PAYMENT_PAYPALWPP_AUTOSELECT_CHEAPEST_SHIPPING', 'No', '利用者がペイパルから戻ってきた際に、配送先選択ページをスキップして最も安価な送料を設定しますか？<br />注意: この項目を利用する場合には利用者が配送方法を簡単に変更できないようにしておく必要があります。 (配送先選択画面を通ることなく)', '6', '25',  'zen_cfg_select_option(array(\'Yes\', \'No\'), ', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values (' エクスプレスチェックアウト: 支払いページをスキップする', 'MODULE_PAYMENT_PAYPALWPP_SKIP_PAYMENT_PAGE', 'Yes', 'もし利用者がエクスプレスチェックアウトを利用した場合、支払い選択ページをスキップしますか？ <br /><strong>(注意: クーポン券やギフト券を有効にしている場合には、この設定にかかわりなく支払いページは表示されます。)</strong>', '6', '25',  'zen_cfg_select_option(array(\'Yes\', \'No\'), ', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('エクスプレスチェックアウト: 顧客アカウントの自動登録', 'MODULE_PAYMENT_PAYPALWPP_NEW_ACCT_NOTIFY', 'Yes', 'もし会員登録を行っていない利用者であった場合 Zencart は自動的に個人情報を保存します。この際に取得した情報を会員情報として登録し、利用者に対してログイン情報を含む登録完了通知をメールで送信しますか？<br />注意: この機能を利用して会員登録を行った場合、電話番号は「顧客登録情報」「注文情報」に反映されません。', '6', '25', 'zen_cfg_select_option(array(\'Yes\', \'No\'), ', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('表示の整列順', 'MODULE_PAYMENT_PAYPALWPP_SORT_ORDER', '0', '表示の整列順を設定します. 数字が小さいほど上位に表示されます。', '6', '25', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('支払い地域', 'MODULE_PAYMENT_PAYPALWPP_ZONE', '0', '地域を選択した場合、選択された地域にたいしてのみ支払い方法が適用されます。', '6', '25', 'zen_get_zone_class_title', 'zen_cfg_pull_down_zone_classes(', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('支払い完了時の注文ステータス', 'MODULE_PAYMENT_PAYPALWPP_ORDER_STATUS_ID', '2', 'この支払い方法で支払いが完了した場合の注文ステータスを設定します。<br />（推奨設定: 処理中[2]）', '6', '25', 'zen_cfg_pull_down_order_statuses(', 'zen_get_order_status_name', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('支払い未完了時の注文ステータス', 'MODULE_PAYMENT_PAYPALWPP_ORDER_PENDING_STATUS_ID', '1', 'この支払い方法で支払いが未完了の場合の注文ステータスを設定します。 <br />（推奨設定: 処理待ち[1]）', '6', '25', 'zen_cfg_pull_down_order_statuses(', 'zen_get_order_status_name', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('返金時の注文ステータス', 'MODULE_PAYMENT_PAYPALWPP_REFUNDED_STATUS_ID', '1', 'この支払い方法で返金になった場合の注文ステータスを設定します。<br />（推奨設定: 処理待ち[1]）', '6', '25', 'zen_cfg_pull_down_order_statuses(', 'zen_get_order_status_name', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('ペイパルページスタイル', 'MODULE_PAYMENT_PAYPALWPP_PAGE_STYLE', 'Primary', 'ペイパルに移動した際に表示される画面レイアウトスタイルの指定です。ペイパルの個人設定にある<strong>支払いページのカスタマイズ</strong>で希望の表示スタイルを指定する事ができます。文字列の完全一致で指定してください。', '6', '25', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('PayPal で表示するショップ名', 'MODULE_PAYMENT_PAYPALWPP_BRANDNAME', '', 'PayPal の画面を表示させたときに、画面内に表示するショップ名を指定します。　空欄にした場合、一般設定で指定したショップ名が表示されます。', '6', '25', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('支払い処理', 'MODULE_PAYMENT_PAYPALWPP_TRANSACTION_MODE', 'Final Sale', '支払い時の処理ステータス<br />与信のみ - Auth Only<br />支払い確定 - Final Sale<br /><strong>デフォルト: 支払い確定</strong>', '6', '25', 'zen_cfg_select_option(array(\'Auth Only\', \'Final Sale\'), ',  now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('支払い通貨', 'MODULE_PAYMENT_PAYPALWPP_CURRENCY', 'Selected Currency', 'Paypalに対して注文金額はどの通貨で送信しますか？<br />注意: もし、サポートされていない通貨でペイパルに送信された場合には、自動的にUSDとして扱われます。 (UKアカウントの場合には GBP になります)<br /><strong>デフォルト: Selected Currency（ショップで選択された通貨）</strong>', '6', '25', 'zen_cfg_select_option(array(\'Selected Currency\', \'Only USD\', \'Only AUD\', \'Only CAD\', \'Only EUR\', \'Only GBP\', \'Only CHF\', \'Only CZK\', \'Only DKK\', \'Only HKD\', \'Only HUF\', \'Only JPY\', \'Only NOK\', \'Only NZD\', \'Only PLN\', \'Only SEK\', \'Only SGD\', \'Only THB\', \'Only MXN\', \'Only ILS\', \'Only PHP\', \'Only TWD\', \'Only BRL\', \'Only MYR\', \'Only TRY\', \'Only INR\'), ', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('eCheck を許可しますか？', 'MODULE_PAYMENT_PAYPALEC_ALLOWEDPAYMENT', 'Instant Only', '即時決済方式以外の eCheck（電子小切手）を許可しますか？<br>Any:すべて許可<br>Instant Only:即時決済のみ', '6', '25', 'zen_cfg_select_option(array(\'Any\', \'Instant Only\'), ', now())");
    ...
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('API署名 -- APIユーザー名', 'MODULE_PAYMENT_PAYPALWPP_APIUSERNAME', '', 'ペイパルのAPI署名に表示される「APIユーザー名」を指定します。メールアドレスに似た形式の文字列ですので、完全一致で指定してください。', '6', '25', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, set_function, use_function) values ('API署名 -- APIパスワード', 'MODULE_PAYMENT_PAYPALWPP_APIPASSWORD', '', 'ペイパルのAPI署名に表示される「APIパスワード」を指定します。16文字の英数文字列ですので、完全一致で指定してください。', '6', '25', now(), 'zen_cfg_password_input(', 'zen_cfg_password_display')");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, set_function, use_function) values ('API署名 -- 署名', 'MODULE_PAYMENT_PAYPALWPP_APISIGNATURE', '', 'ペイパルのAPI署名に表示される「署名」を指定します。56文字の英数記号の文字列ですので、完全一致で指定してください。', '6', '25', now(), '', 'zen_cfg_password_display')");
    ...
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('モード', 'MODULE_PAYMENT_PAYPALWPP_MODULE_MODE', 'PayPal', 'どの PayPal（ペイパル）API システムを利用していますか？<br /><br /><strong>1. PayPal</strong> <br> 通常のペイパルアカウントによるエクスプレスチェックアウト<br /><font color=green>1を選択している場合には、上部のAPI設定が必要になります。</font><br /><strong>2. Payflow-UK</strong> <br> ウェブサイトペイメントプロ UK Payflow エディション<br /><strong>3. Payflow-US</strong> <br> Payflow Pro ゲートウェイ専用<br /><font color=green> 2 と 3 の場合には、以下にある<strong>PAYFLOW 設定</strong>が必要になります。(Payflowアカウントを持っている事が必要です)</font>
<!--<br /><strong>4. PayflowUS+EC</strong> = Payflow Pro with Express Checkout-->', '6', '25',  'zen_cfg_select_option(array(\'PayPal\', \'Payflow-UK\', \'Payflow-US\'), ', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('デバッグモード', 'MODULE_PAYMENT_PAYPALWPP_DEBUGGING', 'Off', 'デバッグモードを利用しますか？　エラー通信内容の詳細をショップオーナーにメールで送信します。<br />Off - エラーログは保存しません <br />Alerts Only - 警告のみ<br />Log File - ログファイルとして保存<br/>Log and Email - ログファイルとして保存すると共に、メールで内容を送信', '6', '25', 'zen_cfg_select_option(array(\'Off\', \'Alerts Only\', \'Log File\', \'Log and Email\'), ', now())");

    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('PayPal マーチャントアカウントID', 'MODULE_PAYMENT_PAYPALWPP_MERCHANTID', '', 'PayPal のマーチャントアカウントIDを入力してください。　InContext モードを選択した場合に利用されます。 この値は、PayPal アカウントにログインして、「アカウント設定」＞「事業情報」のページから確認できます。　「FDEFDEFDEFDE11」のような形の文字列です。', '6', '25', now())");
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('InContext サイト内チェックアウトモード', 'MODULE_PAYMENT_PAYPALWPP_CHECKOUTSTYLE', 'InContext', 'PayPal 支払手続き画面を、ショップの画面上に呼び出す形で表示させる事で使いやすさをアップさせてモードですが、Paypal アカウントを持っている人しか決済できなくなります。（このモードを利用するには、上部の「マーチャントアカウントID」の入力が必須です）。　PayPalアカウントを持っていない人でもカード決済が選択できる旧方式の選択も可能です。この場合、これまでどおりページが完全にリダイレクトします。<br>InContext:InContext モード<br>Old:旧方式', '6', '25', 'zen_cfg_select_option(array(\'InContext\', \'Old\'), ', now())");
