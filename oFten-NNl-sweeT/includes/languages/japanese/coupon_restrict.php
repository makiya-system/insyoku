...
define('HEADER_MANUFACTURER_NAME', '<br> -- OR -- <br>' . 'メーカー名: ');
define('TEXT_ALL_MANUFACTURERS_ADD', 'すべてのメーカー製品を追加する');
define('TEXT_ALL_MANUFACTURERS_REMOVE', 'すべてのメーカー製品を削除する');

define('HEADER_PRODUCT_STATUS', 'ステータス');
define('HEADER_PRODUCT_MODEL', '型番');

define('ERROR_RESET_CATEGORY_MANUFACTURER', 'カテゴリとメーカーによるフィルタがリセットされました。両方同時に指定することは出来ません。');

define('TEXT_PULLDOWN_ALLOW', '許可');
define('TEXT_PULLDOWN_DENY', '不許可');
define('TEXT_SUBMIT_CATEGORY_ADD', '追加');
define('TEXT_SUBMIT_PRODUCT_UPDATE', '更新');
