...
define('TABLE_HEADING_VISIBLE', '表示:');

define('TABLE_HEADING_PAGE_OPEN_NEW_WINDOW', '新しいウィンドウを開く:');
define('TABLE_HEADING_PAGE_IS_SSL', 'ページはSSLです:');
define('TABLE_HEADING_PAGE_IS_VISIBLE', 'ページを表示:');
define('TABLE_HEADING_PAGE_IS_VISIBLE_EXPLANATION', ' ヘッダやフッタ、サイドボックスに表示しなくても、ページ自体は表示します。<br>
(「ページを表示」や「ヘッダ」「フッター」「サイドボックス」を全て"いいえ"に設定した場合、直接URLを指定してアクセスがあった場合には「ページが見つかりません」になります)');
...
define('TEXT_ALT_URL_EXPLAIN', '内部リンクURLが指定されるとHTML コンテンツは無視され、内部リンクはリンクとして使用されるURLに変換されます。<br />例: index.php?main_page=reviews<br />マイページの例: index.php?main_page=account （マイページですので ページはSSLです: はYesにチェックを入れてください。）');

define('TEXT_ALT_URL_EXTERNAL', '外部リンク URL:');
define('TEXT_ALT_URL_EXTERNAL_EXPLAIN', '外部リンクURLが指定されるとHTML コンテンツは無視され、外部リンクはリンクとして使用されるURLに変換されます。<br />外部リンクへの例: http://www.sashbox.net');
