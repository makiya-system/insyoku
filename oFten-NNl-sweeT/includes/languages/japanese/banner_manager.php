...
define('TEXT_BANNERS_URL', 'バナーリンク先URL:');
define('TEXT_BANNERS_GROUP', 'バナー グループ:');
define('TEXT_BANNERS_NEW_GROUP', ' 新しいグループを作成する場合は、下のテキストボックスに直接グループ名を入力してください。');
define('TEXT_BANNERS_IMAGE', 'バナー画像ファイル:');
define('TEXT_BANNERS_IMAGE_LOCAL', '  サーバー上のにある画像を利用する場合は、下のテキストボックスに直接パスとファイル名を入力してください。');
define('TEXT_BANNERS_IMAGE_TARGET', '画像保存先ディレクトリ:');
define('TEXT_BANNER_IMAGE_TARGET_INFO', '<strong>推奨のバナー保存先ディレクトリ:</strong> ' . DIR_FS_CATALOG_IMAGES . 'banners/');
define('TEXT_BANNERS_HTML_TEXT_INFO', '<strong>注意: HTMLバナーはクリックの記録がされません。</strong>');
define('TEXT_BANNERS_HTML_TEXT', 'HTML テキスト:');
define('TEXT_BANNERS_ALL_SORT_ORDER', 'ソート順 - banner_box_all');
define('TEXT_BANNERS_ALL_SORT_ORDER_INFO', '<strong>注意: banner_box_all サイドボックスでは、すべてのバナーが固定でリスト表示されます。</strong>');
...
define('TEXT_INFO_BANNER_STATUS', '<strong>注意:</strong> バナーのステータスは、指定された「開始日」「終了日」並びに「表示回数」の設定によって自動更新されます。');
define('TEXT_BANNERS_OPEN_NEW_WINDOWS', 'バナーを新しいウィンドウで開く');
define('TEXT_INFO_BANNER_OPEN_NEW_WINDOWS', '<strong>注意:</strong>バナーを新しいウィンドウで開きます');
define('TEXT_BANNERS_ON_SSL', 'SSLページでのバナー表示');
define('TEXT_INFO_BANNER_ON_SSL', '<strong>注意:</strong>このバナーがSSLページでエラーなしに表示される場合は、Yes に設定してください。No に設定するとSSLページではこのバナーはスキップされます。');
