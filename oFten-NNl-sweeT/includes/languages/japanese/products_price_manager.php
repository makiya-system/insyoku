...
define('TEXT_PRICE_NET', '価格 (Net)');
define('TEXT_PRICE_GROSS', '価格 (Gross)');
define('TEXT_PRODUCT_AVAILABLE_DATE', '提供開始日:');
...
define('TEXT_SPECIALS_SPECIAL_PRICE_NET', '特価: (Net)');
define('TEXT_SPECIALS_SPECIAL_PRICE_GROSS', '特価: (Gross)');
