...
define('TEXT_DUPLICATE_IPS', '重複しているIPアドレス: ');
define('TEXT_TOTAL_UNIQUE_USERS', 'ユニークユーザー合計: ');
...
define('TEXT_WHOS_ONLINE_TIMER_FREQ5', '5分');
define('TEXT_WHOS_ONLINE_TIMER_FREQ6', '10分');
define('TEXT_WHOS_ONLINE_TIMER_FREQ7', '14分');