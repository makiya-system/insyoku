 ...
 * File Built by Zen Cart Installer on Thu Apr 30 2020 04:15:27
 */
 ...
 */
define('HTTP_SERVER', 'https://192.168.3.18');
/**
 ...
 */
define('HTTP_CATALOG_SERVER', 'https://192.168.3.18');
define('HTTPS_CATALOG_SERVER', 'https://192.168.3.18');
 ...
 */
define('DIR_WS_CATALOG', '/insyoku/');
define('DIR_WS_HTTPS_CATALOG', '/insyoku/');

/**
 * This is the complete physical path to your store's files.  eg: /var/www/vhost/accountname/public_html/store/
 * Should have a closing / on it.
 */
define('DIR_FS_CATALOG', 'C:/xampp/htdocs/insyoku/');
...
define('DB_PREFIX', 'insyoku1_'); // prefix for database table names -- preferred to be left empty
define('DB_CHARSET', 'utf8mb4'); // 'utf8mb4' or older 'utf8' / 'latin1' are most common
define('DB_SERVER', '192.168.3.101');  // address of your db server
define('DB_SERVER_USERNAME', 'aotan');
define('DB_SERVER_PASSWORD', 'tatu19770928');
define('DB_DATABASE', 'insyoku');
