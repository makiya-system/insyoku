...
// hidden fields not changeable on products page
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9 col-md-6">
        <?php echo zen_draw_pull_down_menu('artists_id', $artists_array, $pInfo->artists_id, 'class="form-control"'); ?>
    </div>
  </div>
  <div class="form-group">
      <?php echo zen_draw_label(TEXT_PRODUCTS_RECORD_COMPANY, 'record_company_id', 'class="col-sm-3 control-label"'); ?>
    <div class="col-sm-9 col-md-6">
        <?php echo zen_draw_pull_down_menu('record_company_id', $record_company_array, $pInfo->record_company_id, 'class="form-control"'); ?>
    </div>
  </div>
  <div class="form-group">
