...
*/
      ...
      if ($error == false) {
        ...
        $sql_data_array[] = array('fieldName'=>'entry_telephone', 'value'=>$customers_telephone, 'type'=>'stringIgnoreNull');    
        $sql_data_array[] = array('fieldName'=>'entry_fax', 'value'=>$customers_fax, 'type'=>'stringIgnoreNull');
    ...
    default:
      $customers = $db->Execute("SELECT c.customers_id, c.customers_gender, c.customers_firstname,
                                        ...
                                        a.entry_firstname_kana as firstname_kana, a.entry_lastname_kana as lastname_kana
    ...
    <div class="container-fluid">
      ...
      if ($action == 'edit' || $action == 'update') {
        ...
        <div class="formArea">
          ...
          <div class="form-group">
              <?php echo zen_draw_label(ENTRY_FIRST_NAME_KANA, 'firstname_kana', 'class="col-sm-3 control-label"'); ?>
            <div class="col-sm-9 col-md-6">
                <?php
                if ($error == true) {
                  if ($entry_firstname_error == true) {
                    echo zen_draw_input_field('firstname_kana', htmlspecialchars($cInfo->firstname_kana, ENT_COMPAT, CHARSET, TRUE), zen_set_field_length(TABLE_CUSTOMERS, 'customers_firstname', 50) . ' class="form-control"') . '&nbsp;' . ENTRY_FIRST_NAME_ERROR;
                  } else {
                    echo $cInfo->firstname_kana . zen_draw_hidden_field('firstname_kana');
                  }
                } else {
                  echo zen_draw_input_field('firstname_kana', htmlspecialchars($cInfo->firstname_kana, ENT_COMPAT, CHARSET, TRUE), zen_set_field_length(TABLE_CUSTOMERS, 'customers_firstname', 50) . ' class="form-control"', true);
                }
                ?>
            </div>
          </div>
          ...
          <div class="form-group">
              <?php echo zen_draw_label(ENTRY_LAST_NAME_KANA, 'lastname_kana', 'class="col-sm-3 control-label"'); ?>
            <div class="col-sm-9 col-md-6">
                <?php
                if ($error == true) {
                  if ($entry_lastname_error == true) {
                    echo zen_draw_input_field('lastname_kana', htmlspecialchars($cInfo->lastname_kana, ENT_COMPAT, CHARSET, TRUE), zen_set_field_length(TABLE_CUSTOMERS, 'customers_lastname', 50) . ' class="form-control"') . '&nbsp;' . ENTRY_LAST_NAME_ERROR;
                  } else {
                    echo $cInfo->lastname_kana . zen_draw_hidden_field('lastname_kana');
                  }
                } else {
                  echo zen_draw_input_field('lastname_kana', htmlspecialchars($cInfo->lastname_kana, ENT_COMPAT, CHARSET, TRUE), zen_set_field_length(TABLE_CUSTOMERS, 'customers_lastname', 50) . ' class="form-control"', true);
                }
                ?>
            </div>
          </div>
